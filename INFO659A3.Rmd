...
```{r}
confusion_log <- confusionMatrix(predictions_log, test_update$default.payment.next.month)
...
confusion_dt <- confusionMatrix(predictions_dt, test_update$default.payment.next.month)
